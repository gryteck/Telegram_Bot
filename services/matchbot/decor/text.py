...
info = "Аригато! Я Акира - бот по поиску друзей из Москвы\n" \
       ...
       "Подписывайся на нас в " + f'<a href="{promo_link}">телеграм</a>'
...
def ad() -> str:
    return random.choice([
        f"А ты в курсе про наши <a href='{promo_link}'>азиатские вечеринки</a> в Москве? "
        f"Тусим каждую субботу, не пропусти",
        f"В эту субботу город заснет и только настоящие тусеры застанут <a href='{promo_link}'>АЗИЯ ПАТИ</a>!",
        f"Больше, чем просто азиатские вечеринки в Москве - <a href='{promo_link}'>ASIAN KINGS</a>. Ждем тебя каждую "
        f"субботу!",
        f"Вливайся в семью <a href='{promo_link}'>ASIAN KINGS</a> - где каждую субботу проводят бомбезные вечеринки в "
        f"центре Москвы!",
        f"<a href='{promo_link}'>ASIAN KINGS</a> - единство наций и дружба народов на одном танцполе каждую субботу!",
        f"<a href='{promo_link}'>ASIAN KINGS</a> - там, где все свои!",
        f"Damn, тебе сегодня повезло! Ты получил бесплатную проходку на <a href='{promo_link}'>ASIAN KINGS</a> в эту "
        f"субботу, "
        f"просто покажи переписку на входе!",
        f"Знакомьтесь, листайте мемчики и приходите на вечеринки от <a href='{promo_link}'>Asian Kings</a>!"
    ])
