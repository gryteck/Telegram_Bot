...
start = "Привет-привет. Давай разбираться, что тебе нужно? Жми на кнопку внизу👇"

welcome = "Добро пожаловать на Азия пати и приятного вечера!"
...
admin_menu = "Что делать будем, семпай? ( ◡‿◡ *) \n" \
             ...
             "2. Вычисли по id (・人・) \n" \
             "3. Чекнуть промокод (・人・) \n" \
             "4. Создать промокод ＼(º □ º l|l)/"
