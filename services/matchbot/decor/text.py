...
text_not_meaningful = "Так не пойдет, напиши что-нибудь посодержательней"
...
current_photo = "Вот твое текущее фото, отправляй новое если хочешь его обновить"
...
def write2user(id=None, url=None) -> str:
    if url:
        return f"Скорее пиши [inline mention of a user]({url})"
    else:
        return f"Скорее пиши [inline mention of a user](tg://user?id={id})"
...
def ad() -> str:
    return random.choice([
        ...
        f"Больше, чем просто азиатские вечеринки в Москве - <a href='{promo_link}'>ASIAN KINGS</a>. Ждем тебя каждую субботу!",
        f"Вливайся в семью <a href='{promo_link}'>ASIAN KINGS</a> - где каждую субботу проводят бомбезные вечеринки в центре Москвы!",
        ...
        f"Damn, тебе сегодня повезло! Ты получил бесплатную проходку на <a href='{promo_link}'>ASIAN KINGS</a> в эту субботу, "
