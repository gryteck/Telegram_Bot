...
def set_age():
    return random.choice(["Damn, какое красивое имя, ", "Рада знакомству, ", "Супер, буду звать тебя "])
...
def set_text(text: str = None) -> str:
    description = "Теперь расскажи немного о себе, например:\n" \
...
def adm_cap(a: dict):
    if a['banned']: state = "banned"
    elif a['visible']: state = "active"
    else: state = "inactive"
